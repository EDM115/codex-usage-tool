...
test("collectRolloutEvents parses token_count breakdowns", () => {
  ...
  const sessions = path.join(codexHome, "sessions", "2026", "06", "27");
  mkdirSync(sessions, { recursive: true });
  const rollout = path.join(sessions, "rollout-2026-06-27T10-00-00-00000000-0000-0000-0000-000000000001.jsonl");
  writeFileSync(rollout, [
    JSON.stringify({ timestamp: "2026-06-27T08:00:00.000Z", type: "session_meta", payload: { id: "00000000-0000-0000-0000-000000000001", model: "gpt-5" } }),
    JSON.stringify({ timestamp: "2026-06-27T08:01:00.000Z", type: "turn_context", payload: { model: "gpt-5", reasoning_effort: "high" } }),
    JSON.stringify({
